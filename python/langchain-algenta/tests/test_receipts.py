"""Unit tests for `langchain_algenta.receipts` -- no network, no graph, just the model."""

from __future__ import annotations

from langchain_algenta.receipts import GovernedExecutionReceipt, parse_receipt
