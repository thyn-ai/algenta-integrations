"""Asserts `langchain_algenta.contract`'s embedded constants agree with the real
...
`typescript/algenta-tools/packages/algenta-tools/src/contract-parity.test.ts` exactly.
"""
...
from langchain_algenta.contract import FULL_PROFILE_SENTINEL, NEVER_MODEL_FACING_FIELDS, TOOL_PROFILES


def _find_contract_file() -> Path | None:
    # tests/ -> langchain-algenta/ -> python/ -> repo root
