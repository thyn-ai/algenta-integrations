...
`Algenta's own `apps/mcp_server/README.md` (`thyn-ai/algenta`) states plainly that its canonical
`/mcp` route "implements stateless Streamable HTTP" -- confirmed by reading that file directly,
not assumed. This package exists to make that property *useful*: a `ray_serve_algenta.deployment
