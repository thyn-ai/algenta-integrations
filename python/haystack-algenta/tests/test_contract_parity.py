"""Asserts `haystack_algenta.contract`'s embedded constants agree with the real
...
`python/pydantic-ai-algenta/tests/test_contract_parity.py`, `python/langchain-algenta/tests/test_contract_parity.py`,
and `python/maf-algenta/tests/test_contract_parity.py` exactly.
"""
...
from haystack_algenta.contract import FULL_PROFILE_SENTINEL, NEVER_MODEL_FACING_FIELDS, TOOL_PROFILES


def _find_contract_file() -> Path | None:
    # tests/ -> haystack-algenta/ -> python/ -> repo root
